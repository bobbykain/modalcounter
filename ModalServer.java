 ...
 *
 * The ModalServer uses a ModalHandler whose code is in a separate file.
 * When a client connects, the ModalServer starts a ModalHandler in a separate thread
...
public class ModalServer
{
	...
	private void getConnection()
	{
		...
		try
		{
			...
			while (true)
			{
				...
				// Send to ModalHandler the socket and arraylist of all sockets
				ModalHandler handler = new ModalHandler(connectionSock, this.socketList);
	...
	{
		ModalServer server = new ModalServer();
